        ...
        {props.movies.map((movie, index) => (
          <div className="relative me-4 flex flex-col items-center justify-center shrink-0" key={index}>
            <div className="image-container hover:scale-105 hover:cursor-pointer transition duration-250 ease-in">
              ...
              <div onClick={() => props.handleWatchlistClick(movie)} className="overlay bg-black/75 flex items-center justify-center inset-0 w-75 h-110  opacity-0 text-xl p-5 text-center absolute">
                <WatchlistComponent />
              </div>
            </div>
