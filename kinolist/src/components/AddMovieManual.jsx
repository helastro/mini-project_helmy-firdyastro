    ...
    <div>
      ...
      <form className="space-y-4 mb-4" onSubmit={handleSubmit}>
        <div className="flex flex-col">
          ...
          <input type="text" id="title" value={title} onChange={handleTitleChange} className={`bg-transparent border border-white text-white rounded px-3 py-2 focus:outline-none ${isMobile ? "w-11/12" : "w-full"}`} />
        </div>
        <div className="flex flex-col">
          <label htmlFor="poster" className="text-white">
            URL Poster:
          </label>
          <input type="text" id="poster" value={poster} onChange={handlePosterChange} className={`bg-transparent border border-white text-white rounded px-3 py-2 focus:outline-none ${isMobile ? "w-11/12" : "w-full"}`} />
        </div>
